...
<div id="comment-{{ $comment->getKey() }}" class="media">
    <img class="mr-3" src="http://d1ujqdpfgkvqfi.cloudfront.net/favicon-generator/htdocs/favicons/2015-01-31/843e1907604d903c7d1e16e167df8fcf.ico" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
